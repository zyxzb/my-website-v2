...
const HomeTextSection = () => {
  return (
    <section>
      ...
      <Link
        href='/projects'
        className='mb-14 bg-textDarkBlue p-4 transition hover:bg-textLightBlue hover:text-bgDarkBlue'
      >
        My Projects
      </Link>
      <div>
        ...
        <Link
          href='/contact'
          className='bg-textDarkBlue p-4 transition hover:bg-textLightBlue hover:text-bgDarkBlue'
        >
          Contact
        </Link>
      </div>
